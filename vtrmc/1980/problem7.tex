...
% **Note:** the original problem statement uses two very similar $O$ symbols in
% both cases where we use $O$ and $C$ which is quite confusing. We've tried to
% disambiguate it in this transcription.
